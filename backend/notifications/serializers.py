...
class NotificacionSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = '__all__'
        extra_kwargs = {
            'id': {'help_text': 'Unique notification ID'},
            'usuario_id': {'help_text': 'User ID'},
            'tipo': {'help_text': 'Notification type'},
            'contenido': {'help_text': 'Notification content'},
            'timestamp': {'help_text': 'Notification timestamp'},
            'estado': {'help_text': 'Notification state'},
            'titulo_mensaje': {'help_text': 'Notification title'},
            'cuerpo_mensaje': {'help_text': 'Notification body'},
            'enlace_mensaje': {'help_text': 'Notification link'},
        }
...
class RecomendacionPersonalizadaSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = '__all__'
        extra_kwargs = {
            'id': {'help_text': 'Unique personalized recommendation ID'},
            'notificacion': {'help_text': 'Associated notification'},
            'obra_id': {'help_text': 'Recommended play ID'},
...
class PreferenciasUsuarioSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        extra_kwargs = {
            ...
            'frecuencia_notif': {'help_text': 'Notification frequency'},
        }
